...
# jeżeli użytkownik przekroczył granice 60% ruchów pomiędzy minimalną wartością a maksymalną ruchów to gra kończy się niepowodzeniem, gracz umarł z głodu, np dla poziomu łatwego,
min 5, max 10,
10 - 5 = 5,
60% z 5 = 3,
5 (min) + 3 (60%) = 8,
...
def easy():
    ...
    while actual_position < 5 and all_moves < 10:
        ...
        if user_input_move == losowanie:
            print(f'Good move You made {all_moves} move')
            ostatni_ruch = True
            actual_position += 1
...
def hard():
    ...
    while actual_position < 8 and all_moves < 24:
        ...
        if user_input_move == losowanie:
            ...
            print(f"""Good! {good_moves} good move.
